...
angular.module('locator.accommodation-equipment-chooser', []).directive('accEquChooser', function () {
    ...
    var template = [
        ...
        '<div class="smoker equi-ico pointer tt tt-small" aria-label="Rauchen erlaubt" ng-hide="containsAccommodation(smoker) == false && getJustShowSelected() == true" ng-click="addAccommodationEquipment(smoker)" ng-class="{smokerGrey: containsAccommodation(smoker) == false, smokerWhite: iconsColor == white}"></div>',
